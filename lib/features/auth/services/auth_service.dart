...
/// Authenticate staff or parishioners using Supabase Auth and restore account theme
...
/// Terminate session across Web and Mobile, resetting theme to default light baseline
...
isPasswordRecoveryInProgress = false;
currentUser = null;
AppThemeController.applyUserPreference(false);
}
}

...
void showManualEntryModal(BuildContext context, {VoidCallback? onRecordSaved}) {
  showDialog(
    ...
    builder: (ctx) => _BaptismManualEntryDialog(onRecordSaved: onRecordSaved),
  );
}

class _BaptismManualEntryDialog extends StatefulWidget {
  final VoidCallback? onRecordSaved;

  const _BaptismManualEntryDialog({this.onRecordSaved});

  @override
  State<_BaptismManualEntryDialog> createState() => _BaptismManualEntryDialogState();
}

class _BaptismManualEntryDialogState extends State<_BaptismManualEntryDialog> {
  ...
  Future<void> _selectDate(BuildContext context, bool isBirthDate) async {
    ...
    if (picked != null) {
      setState(() {
        if (isBirthDate) {
          _dateOfBirth = picked;
          // Auto-calculate approximate age if empty
  ...
  Future<void> _submitForm() async {
    ...
    if (!_formKey.currentState!.validate()) {
      setState(() {
        _errorMessage = 'Please correct the highlighted fields before submitting.';
      });
      return;
    }
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Baptism record successfully saved and registered.'),
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildSectionHeader('1. Canonical Record Reference', Icons.menu_book),
                      Row(
                        children: [
                          Expanded(
                      ...
                      _buildSectionHeader("2. Child's Information", Icons.child_care),
                      Row(
                        children: [
                          Expanded(
                            flex: 2,
                      ...
                      _buildSectionHeader("3. Father's Information", Icons.person),
                      Row(
                        children: [
                          Expanded(
                            child: _buildTextFormField(
                      ...
                      _buildSectionHeader("4. Mother's Information", Icons.person_outline),
                      Row(
                        children: [
                          Expanded(
                            child: _buildTextFormField(
                      ...
                      _buildSectionHeader("5. Parents' Contact & Residence", Icons.home_outlined),
                      Row(
                        children: [
                          Expanded(
                            child: _buildTextFormField(
                      ...
                      // Section 6: Sponsors / Godparents
                      _buildSectionHeader('6. Godparents / Sponsors', Icons.people_outline),
                      const Text(
                        'Canonical rules specify Sponsor 1 and Sponsor 2.',
                      ...
                      // Section 7: Baptism & Minister
                      _buildSectionHeader('7. Baptism & Minister Details', Icons.church),
                      _buildTextFormField(

...
class _ParishCalendarPageState extends State<ParishCalendarPage> {
        ...
        return Scaffold(
          ...
          body: Column(
            children: [
              ...
              _buildControlHeader(isDesktop),
              _buildFilterAndLegendBar(isDesktop),
              ...
              Expanded(
                child: _buildCurrentCalendarView(isDesktop),
              ),
            ],
          ),
  ...
  // ---------------------------------------------------------------------------
  Widget _buildControlHeader(bool isDesktop) {
    return Container(
  ...
  // ---------------------------------------------------------------------------
  // Filters & Legend Combined Row
  // ---------------------------------------------------------------------------
  Widget _buildFilterAndLegendBar(bool isDesktop) {
    return Container(
      color: ParishColors.cardWhite,
  ...
  // ---------------------------------------------------------------------------
  Widget _buildCurrentCalendarView(bool isDesktop) {
    switch (_currentView) {
      case CalendarViewMode.month:
        return isDesktop ? _buildDesktopSplitMonthView() : _buildMobileMonthView();
      case CalendarViewMode.week:
        return isDesktop ? _buildDesktopWeekBoard() : _buildMobileWeekView();
      case CalendarViewMode.day:
        return _buildDayView(isDesktop);
    }
  }
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  _buildWeekdayHeader(),
                  _buildMonthGrid(isDesktop: true),
                ],
              ),
            ),
          ),
          ...
          // RIGHT PANEL (42% Width): Real-time Selected Date Schedule Details
          Expanded(
            flex: 42,
            child: Container(
        ...
        children: [
          Container(
            ...
            child: Column(
              children: [
                _buildWeekdayHeader(),
                _buildMonthGrid(isDesktop: false),
              ],
            ),
          ),
  ...
  Widget _buildMonthGrid({required bool isDesktop}) {
  ...
  // ===========================================================================
  // 2. WEEK VIEW: 7-Column Board on Desktop, Stacked on Mobile
  // ===========================================================================
  Widget _buildDesktopWeekBoard() {
    final startOfWeek = _selectedDate.subtract(Duration(days: _selectedDate.weekday % 7));
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: isSelected
                            ...
                            : (isMonday ? const Color(0xFFF1F5F9) : ParishColors.marianBlueSurface),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...dayFeasts.map((f) => Container(
                            ...
                            decoration: BoxDecoration(
                              color: f.categorySurfaceColor,
                              borderRadius: BorderRadius.circular(6),
                              border: Border.all(color: f.categoryBadgeColor.withOpacity(0.4)),
                            ),
                            child: Text(
                              f.name,
                              style: TextStyle(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              flex: 6,
              child: ListView(
                children: hours.map((hour) => _buildHourSlot(hour, dayAppointments, isMonday)).toList(),
              ),
            ),
          ],
        ),
  ...
  Widget _buildHourSlot(int hour, List<AppointmentModel> dayAppointments, bool isMonday) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: ParishColors.cardWhite,
          borderRadius: BorderRadius.circular(12),
          border: Border.all(color: colorAppointments.withOpacity(0.5), width: 1.2),
        ),
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
  ...
  Widget _buildEmptyDayCard({bool isMonday = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isMonday ? const Color(0xFFF1F5F9) : ParishColors.backgroundLight,
        borderRadius: BorderRadius.circular(14),
